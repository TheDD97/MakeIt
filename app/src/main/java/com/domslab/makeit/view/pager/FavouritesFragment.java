...
public class FavouritesFragment extends Fragment implements ManualAdapter.OnManualListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Utilities.showProgressDialog(view.getContext(), true);
        ...
        manualCards.addAll(Arrays.asList(new ManualCard(decodedByte, "prova"), new ManualCard(decodedByte, "prova")));
        manualAdapter = new ManualAdapter(getContext(), manualCards, this);
    ...
    */
    ...
    public void onManualClick(int position) {
        System.out.println(manualCards.get(position).getCover() + "\n\n" + manualCards.get(position).getName());
    }
}